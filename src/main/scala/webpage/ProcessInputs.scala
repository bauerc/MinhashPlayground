...
class ProcessInputs(
                     _tokens: Set[(String, Boolean)],
                     _jaccard: Double,
                     _minhashes: List[(Int, Int, Boolean)],
                     _bands: List[(Int, Int, Boolean)]
                   ) {


  def tokens: Set[(String, Boolean)] = _tokens
  def jaccard: Double = _jaccard
  def minhashes: List[(Int, Int, Boolean)] = _minhashes
  def bands: List[(Int, Int, Boolean)] = _bands

  }


object ProcessInputs {
  def apply(mhForm: MinhashForm): ProcessInputs = {
    ...
    new ProcessInputs(tokens, jaccard, minhashes, bands)
  }
